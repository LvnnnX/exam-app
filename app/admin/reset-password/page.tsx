...
export default function AdminResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 text-nike-black">
      <div className="mx-auto flex min-h-screen max-w-md items-center">
        <div className="w-full rounded-[32px] border-2 border-slate-100 bg-white p-8 shadow-xl shadow-slate-200/50 md:p-10">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-[24px] bg-dark-800 text-2xl font-bold text-white">*</div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                minLength={8}
                className="w-full rounded-2xl border-2 border-slate-100 bg-slate-50 px-5 py-4 text-sm font-medium text-slate-700 transition-all focus:border-link-blue focus:outline-none focus:ring-4 focus:ring-link-blue/10"
                required
              />
            </div>
            ...
            <button type="submit" disabled={loading} className="mt-4 w-full rounded-2xl bg-dark-800 py-4 text-sm font-bold text-white shadow-lg transition-all hover:opacity-90 disabled:opacity-50">
